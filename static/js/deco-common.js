...
function search_click(){
    ...
    if(type == "course"){
        request_url = "/course/list?keywords="+keywords + "&type=" + type
    }else if(type == "teacher"){
        request_url = "/org/teacher/list?keywords="+keywords + "&type=" + type
    }else if(type == "org"){
        request_url = "/org/list?keywords="+keywords + "&type=" + type
    }
